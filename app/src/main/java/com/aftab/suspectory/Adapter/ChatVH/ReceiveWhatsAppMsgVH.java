...
public class ReceiveWhatsAppMsgVH extends RecyclerView.ViewHolder {
    private final TextView tvMessage;
    private final TextView tvDate;
    private final ImageView ivLocation;

    public ReceiveWhatsAppMsgVH(@NonNull View itemView) {
        super(itemView);
        tvMessage = itemView.findViewById(R.id.tv_receive_message);
